...
if not telco_sample.empty:
  ...
  if len(expected_cols) != len(telco_sample.columns):
    ...
    if (expected_cols != telco_sample.columns).any():
      ...
      if modelo == opa:
        url = 'https://raw.githubusercontent.com/marcelobour/telco_churn/main/models/aucpr-average_precision.txt'
      else: 
        url = 'https://raw.githubusercontent.com/marcelobour/telco_churn/main/models/aucpr-recall.txt'
